...
if "release" in sys.argv[-1]:
    ...
    os.system("rm -rf dist/the-friendly-planets*")
    sys.exit()

# a little kludge to get the version number from __version__
exec(open("thefriendlyplanets/version.py").read())

# run the setup function
setup(
    # the name folks can use to search for this with pip
    name="the-friendly-planets",
    # what version of the code is this?
    version=__version__,
    # what's a short description of the package?
    description="Tools for making easy-to-interpret aligned astronomical images of planets and moons.",
    ...
    url="https://github.com/zkbt/the-friendly-planets",
